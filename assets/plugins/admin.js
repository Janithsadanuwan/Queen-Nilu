...
Nilu.operate({pattern: 'demote ?(.*)', fromMe: true, onlyGroup: true, desc: Lang.DEMOTE_DESC, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    await QueenNilu.Nilu_setup()
...
Nilu.operate({pattern: 'mute', fromMe: true, onlyGroup: true, desc: Lang.MUTE_DESC, dontAddCommandList: true, deleteCommand: false}, (async (message) => {    
    var im = await checkImAdmin(message);
    await QueenNilu.Nilu_setup()
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Nilu.operate({pattern: 'unmute', fromMe: true, onlyGroup: true, desc: Lang.UNMUTE_DESC, dontAddCommandList: true, deleteCommand: false}, (async (message) => {    
    var im = await checkImAdmin(message);
    await QueenNilu.Nilu_setup()
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Nilu.operate({pattern: 'clear', fromMe: true, desc: Lang.END, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    await QueenNilu.Nilu_setup()
...
Nilu.operate({pattern: 'subject ?(.*)', onlyGroup: true, fromMe: true, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    var im = await checkImAdmin(message);
    await QueenNilu.Nilu_setup()
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Nilu.operate({pattern: 'grpdesc ?(.*)', onlyGroup: true, fromMe: true, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    var im = await checkImAdmin(message);
    await QueenNilu.Nilu_setup()
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Nilu.operate({pattern: 'revoke', onlyGroup: true, fromMe: true, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    var im = await checkImAdmin(message);
    await QueenNilu.Nilu_setup()
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Nilu.operate({pattern: 'del', fromMe: true,  deleteCommand: false, dontAddCommandList: true}, async (message) => {
    await QueenNilu.nilu_setup()
    await message.client.deleteMessage(message.jid, {id: message.reply_message.id, remoteJid: message.jid, fromMe: true})

});

Nilu.operate({pattern: 'invite', fromMe: true, onlyGroup: true, desc: Lang.INVITE_DESC, dontAddCommandList: true, deleteCommand: false}, (async (message) => {    
    var im = await checkImAdmin(message);
    await QueenNilu.nilu_setup()
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
