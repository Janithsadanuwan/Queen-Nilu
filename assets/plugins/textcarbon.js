...
const copy = Build.CAP

const Language = require('../language');
const Lang = Language.getString('textcarbon');
...
if (Build.WORKTYPE == 'private') {
    ...
    Nilu.operate({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC,  deleteCommand: false}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: copy, thumbnail: qathmub})
