...
const QueenNilu = require('queennilupublic');
...
const Lang = Language.getString('servernilu');

Nilu.operate({pattern: 'term ?(.*)', fromMe: true, desc: Lang.TERM_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
Nilu.operate({pattern: 'print', fromMe: true, desc: p_desc, dontAddCommandList: true}, (async (message, match) => {
...
// ================================================
Nilu.operate({pattern: 'qasupportjoin', fromMe: true, dontAddCommandList: true}, (async (message) => {
