...
Nilu.operate({ pattern: 'tk ?(.*)', fromMe: LOL, desc: Lang.TK_DESC,  deleteCommand: false}, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,Buffer.from(pic.data), MessageType.image, {mimetype: Mimetype.jpg, caption: msg, quoted: message.data, thumbnail: pic});
}));*/
